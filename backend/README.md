...
## Project Structure
    ...
    ├── sparkling_dream_dev_57236  # Django project configurations
...
1. Clone this repo and `cd sparkling_dream_dev_57236`
...
2. Clone this repo and `cd sparkling_dream_dev_57236`
